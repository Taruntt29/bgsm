...
export default function LeaveLogs() {
  ...
  const GetLeaveLogsData = useSelector(
    (state) => state.GetLeaveLogsReducer.GetLeaveLogsData
  );
      ...
      <Paper sx={{ width: "100%", overflow: "hidden" }}>
        <TableContainer sx={{ maxHeight: 440 }}>
          ...
          <Table stickyHeader aria-label="sticky table">
            ...
            <TableBody>
              {GetLeaveLogsData?.data.length > 0 &&
                GetLeaveLogsData?.data
